...
public class AST {
    ...
    private void makeNode(String type, String value, int lineNumber) {
        semanticStack.push(new ASTNode(type, value, lineNumber));
    ...
    private void makeFamily(String parentName, int childrenSize) {
        ASTNode parent = new ASTNode(parentName, parentName, -1);
        if (-1 == childrenSize) {
            ASTNode temp = null;
    ...
    void doSemanticAction(int semanticAction, Token token) {
        switch (semanticAction) {
            case 1:
                makeNode(token.getType(), token.getValue(), token.getLineNumber());
                break;
            case 2:
                makeNode("inherList", "inherList", 0);
                break;
            case 3:
            ...
            case 9:
                ...
                break;
            case 10:
                makeNode("fparmList", "fparmList", 0);
                break;
            case 11:
            ...
            case 18:
                ...
                break;
            case 19:
                makeNode("scopeSpec", "scopeSpec", 0);
                break;
            case 20:
    ...
    String print() {
        if (semanticStack.isEmpty()) return "";
